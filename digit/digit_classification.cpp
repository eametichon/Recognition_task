///////////////////////////////////////////////////////////////////////////////
//////                                                                           //
////// Program Name : digit_classification.cpp                                   //
...
void compute_accuracy(){
  ...
  for(i = 0; i < NUMBER_OF_TESTING; i++){
    ...
    if(predicted_testing_label[i] == testing_label[i]){
      ...
      printf("Correct: %d, Misclassified to %d\n\n\n", testing_label[i], predicted_testing_label[i]);
      for(j = 0; j < 28; j++){
        for(k = 0; k < 28; k++){
...
void compute_four_pair_of_odds_ratio(){
  ...
  for(times = 0; times < 4; times++){
    ...
    printf("Odd ratio for class %d and class %d:\n", confuse_from, confuse_to);
